const AuthImagePattern = () => {
    return (
        <div className="hidden lg:flex items-center justify-center px-10 py-12">
            <div className=" p-8 rounded-xl shadow-xl flex flex-col items-center space-y-6 max-w-sm w-full">
                {/* Title */}
                <h2 className="text-2xl font-semibold">To use WhatsUp on your computer:</h2>

                {/* Subtitle */}
                <ul className="text-s text-left list-disc pl-5 space-y-1">
                ...
                {/* Optional note */}
                <p className="text-xs">The QR code is valid for 1 minute</p>
