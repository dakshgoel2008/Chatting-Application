...
const LoginPage = () => {
    ...
    const handleGoogleLogin = async () => {
        setTimeout(() => {
            alert("Demo: Later, this would initiate the Google Login!");
        }, 1000);
    };

    const handleGitHubLogin = async () => {
        setTimeout(() => {
            alert("Demo: Later, this would initiate the GitHub Login!");
        }, 1000);
    };
    return (
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 text-lg">Log in to continue your journey</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors duration-200 group"
